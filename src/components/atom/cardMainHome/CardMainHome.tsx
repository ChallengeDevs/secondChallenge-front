...
import { SituationPlay } from "../situationPlay/SituationPlay";
...
export const CardMainHome: React.FC<Models.Event> = ({ event, teams }) => {
  ...
  return (
    <section className="w-[30rem] flex flex-col justify-center gap-2 items-center h-72 rounded-xl bg-black border-black border-2 p-2">
